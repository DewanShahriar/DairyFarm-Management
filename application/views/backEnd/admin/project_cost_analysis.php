            ...
            <div class="box box-6a8d9d">
                ...
                <div class="box-body">
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #6a8d9d;margin: 10px 30px 40px 25px;padding: 30px 0px 30px 0px;">
                        <form action="<?php echo base_url('admin/report/project_cost_analysis') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-3">
                    ...
                    <table class="table table-striped table_th_6A8D9D">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a target="_blank" href="<?= base_url('admin/report/search?account_head_id='.$value->head_id.'&project_id='.$value->pid); ?>" style="text-decoration: none; color: #333;" ><?php echo $value->hname; ?></a></td>
