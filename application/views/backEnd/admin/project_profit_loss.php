        ...
        <div class="col-md-12">
            ...
            <div class="box box-6a8d9d">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('project_profit_loss'); ?> </h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #6a8d9d;margin: 10px 30px 40px 25px;padding: 30px 0px 30px 0px;">
                        <form action="<?php echo base_url('admin/report/profit_loss') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-4">
        ...
        <div class="invoice" id="printablearea">
            ...
            <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                    <address>
                        <b><?php echo $this->lang->line('project'); ?></b> : <strong><?php echo $search_data->name; ?></strong><br>             
                        <b><?php echo $this->lang->line('location'); ?></b>: <?php echo $search_data->address; ?><br>
                    </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4">
                    <h4>
                        <b><center> Project Profit/Loss Statement </center></b>
                    </h4>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col pull-right">
                    
                    <b><?php echo $this->lang->line('start_date'); ?>:</b> <?php echo date('d-M-Y',strtotime($search_data->project_start_date)); ?>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
                    ...
                    <table class="table table-striped table_th_6A8D9D">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 10%;text-align: right;"><?php echo $this->lang->line('withdraw'); ?></th>
                                <th style="width: 10%; text-align: right"><?php echo $this->lang->line('income'); ?></th>
                                <th style="width: 10%; text-align: right"><?php echo $this->lang->line('expence'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                                (float)$income_add = 0.00; (float)$expense_Add = 0.00;(float)$withdraw_Add = 0.00; $quantity = 0;
                            ...
                            <tr>
                                ...
                                <td><a target="_blank" href="<?= base_url('admin/report/search?account_head_id='.$value->head_id.'&project_id='.$value->pid); ?>" style="text-decoration: none; color: #333;" ><?php echo $value->name; ?></a></td>
                                ...
                                <td style="text-align: right; "><?php if ($value->category == 2) {echo number_format((float)$value->amount, 2, '.', ''); $withdraw_Add += $value->amount; } ?></td>
                                <td style="text-align: right; "><?php if ($value->category == 1) {echo number_format((float)$value->amount, 2, '.', ''); $income_add += $value->amount; } ?></td>

                                <td style="text-align: right; "><?php if ($value->category == 0) {echo number_format((float)$value->amount, 2, '.', ''); (float)$expense_Add += (float)$value->amount; } ?></td>
                            </tr>
                            <?php } ?>
                            <tr>
                                <td colspan="4" style="text-align: right;"><b>  <?php echo $this->lang->line('total'); ?>  </b></td>

                                <td style="text-align: right;"><?= $quantity; ?></td>

                                <td></td>

                                <td style="text-align: right; "><?= number_format((float)$withdraw_Add, 2, '.', ''); ?></td>
                                <td style="text-align: right; "><?= number_format((float)($income_add - $withdraw_Add), 2, '.', ''); ?></td>

                                <td style="text-align: right; "><?= number_format((float)$expense_Add, 2, '.', ''); ?></td> 
                            </tr>
                        </tbody>
                    </table>
                </div>
