        ...
        <div class="col-xs-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('loss_project'); ?> </h3>
                    ...
                    <table id="userListTable" class="table table-bordered table-striped table_th_purple">
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><?php echo $this->lang->line('loss'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                                $sl = 0;
                                foreach ($loss_project as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td> <?php echo number_format((float)$value->amount-$value->budget, 2, '.', '').'৳'; ?> </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
