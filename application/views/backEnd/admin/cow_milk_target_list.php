        ...
        <div class="col-xs-12">
            <div class="box box-info box-solid">
                ...
                <div class="row" style="box-shadow: 0px 0px 10px 0px #3c8dbc; margin: 8px 53px 20px 55px; padding:20px 4px 20px 4px;">
                   <form action="<?php echo base_url('admin/cow-milk-target/list') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="start_date" placeholder="<?php echo $this->lang->line('milk_start_date'); ?> " class="form-control inner_shadow_primary date"  type="text" autocomplete="off" value="<?= $search['start_date']; ?>">
                                    </div>
                                </div>
                            </div>
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="cowDetailsList" class="table table-bordered table-striped table_th_info">
                        <thead>
                            <tr>
                                <th style="width: 5%;"><?php echo $this->lang->line('sl'); ?></th>
                                <th style="width: 15%;"><?php echo $this->lang->line('cow_no'); ?></th>
                                <th style="width: 35%;"><?php echo $this->lang->line('milk_start_date'); ?></th>
                                <th style="width: 35%;"><?php echo $this->lang->line('milk_target'); ?></th>
                        ...
                        <tbody>
                            <?php 
                                $sl = 1;
                                $total_target = 0;
                                foreach ($cow_milk_target_list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="<?php echo base_url('admin/cow-milk-target/edit/'.$value->id); ?>" class="btn btn-sm bg-teal"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo base_url('admin/cow-milk-target/delete/'.$value->id); ?>" class="btn btn-sm btn-danger" onclick = 'return confirm("Are You Sure?")'><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <tr>
