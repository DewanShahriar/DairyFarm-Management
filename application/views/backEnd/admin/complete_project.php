        ...
        <div class="col-xs-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('complete_project'); ?> </h3>
                    ...
                    <table id="userListTable" class="table table-bordered table-striped table_th_purple">
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><?php echo $this->lang->line('project_id'); ?></th>
                        ...
                        <tbody>
                            <?php 
                                foreach ($complete_project as $key => $value) {
                                    ?>
                            <tr>
                                <td> <?php echo ++$key ; ?> </td>
                                ...
                                <td> <?php if($value->category == 0){echo number_format((float)$value->amount, 2, '.', '').'৳';} ?> </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
