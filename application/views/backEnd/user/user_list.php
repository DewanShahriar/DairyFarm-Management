            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url('user/add_user') ?>" class="btn bg-orange btn-sm"><i class="fa fa-plus"></i>Add User</a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="<?php echo base_url().'user/edit_user/'.$value['id'] ;?>"><?php echo $this->lang->line('update'); ?></a></li>
                                            <li><a href="<?php echo base_url().'user/suspend_user/'.$value['id'].'/'. abs($value['status']-1) ;?>"> <?php echo $value['status'] == 0 ? $this->lang->line('active'):$this->lang->line('suspend'); ?> </a></li>
                                            <li class="divider"></li>
                                            <li><a href="<?php echo base_url().'user/delete_user/'.$value['id'] ;?>" onclick="return confirm('Are you sure?')" ><?php echo $this->lang->line('delete'); ?></a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
