            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #c99568; margin: 10px 30px 40px 25px; padding: 30px 0px 30px 0px;">
                        <form action="<?php echo base_url('user/cashin_withdraw_join/edit/'.$edit_info->id) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-5">
                    ...
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #3c8dbc;margin: 10px 30px 40px 25px;padding: 30px 0px 30px 0px;">
                        <form action="<?php echo base_url('user/cashin_withdraw_join/add/') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="col-md-12">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                            ...
                            <table id="userListTable" class="table table-bordered table-striped table_th_orange">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('user/cashin_withdraw_join/edit/'.$value->id); ?>" class="btn btn-sm bg-green"> <i class="fa fa-edit"></i> </a>
                                            <a href="<?= base_url('user/cashin_withdraw_join/delete/'.$value->id); ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm bg-orange"> <i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
