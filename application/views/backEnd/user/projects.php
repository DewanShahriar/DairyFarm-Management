                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="<?php echo base_url('user/projects/delete/'.$value->id); ?>" class="btn btn-sm btn-danger" onclick = 'return confirm("Are You Sure?")'><i class="fa fa-trash"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() ?>user/projects/add" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="modal fade" id="modal-edit-project" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() ?>user/projects/edit" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row" style="box-shadow: 1px 1px 5px 1px #605CA8; margin: 0px 20px 20px 20px; padding: 25px 0px 15px 0px;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="col-sm-12"><?php echo $this->lang->line('start_date'); ?></label>
    ...
    <div class="modal fade" id="modal-status-change" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() ?>user/projects/statuschange" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row" style="box-shadow: 1px 1px 5px 1px #605CA8; margin: 0px 20px 20px 20px; padding: 25px 0px 15px 0px;">
